...
ALERT_AFTER_N_DAYS = 95
SEND_EVERY_N_DAYS = 3

# Who send the email?
SES_SENDER_EMAIL_ADDRESS = 'bhs9610@naver.com'
# Where did we setup SES?
SES_REGION_NAME = 'ap-northeast-2'
...
If you have any question, please don't hesitate to contact the Support Team at changhyun.kim@knowre.com.
